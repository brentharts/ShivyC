"""Packaged musl source: src/errno/*.c (auto-generated by tools/pack_musl.py; do not edit by hand)."""

CATEGORY = 'errno'

FILES = {
    '__errno_location.c': r'''#include <errno.h>
