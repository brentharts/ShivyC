"""Packaged musl source: src/internal/*.c (auto-generated by tools/pack_musl.py; do not edit by hand)."""

CATEGORY = 'internal'

FILES = {
    'defsysinfo.c': r'''#include "libc.h"

size_t __sysinfo;
''',
    'emulate_wait4.c': r'''#include <sys/wait.h>
#include "syscall.h"
...
#endif
''',
    'floatscan.c': r'''#include <stdint.h>
#include <stdio.h>
#include <math.h>
#include <float.h>
#include <limits.h>
...
''',
    'procfdname.c': r'''#include "syscall.h"
...
''',
    'syscall_ret.c': r'''#include <errno.h>
#include "syscall.h"
...
#endif
''',
    'version.c': r'''#include "version.h"
#include "libc.h"

const char __libc_version[] = VERSION;
''',
    'sh/__shcall.c': r'''#include <features.h>
