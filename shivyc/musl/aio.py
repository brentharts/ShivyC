"""Packaged musl source: src/aio/*.c (auto-generated by tools/pack_musl.py; do not edit by hand)."""

CATEGORY = 'aio'

FILES = {
    'aio.c': r'''#include <aio.h>
#include <pthread.h>
#include <semaphore.h>
#include <limits.h>
#include <errno.h>
