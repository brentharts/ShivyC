...
volatile_kw = TokenKind("volatile", keyword_kinds)
restrict_kw = TokenKind("restrict", keyword_kinds)
atomic_kw = TokenKind("_Atomic", keyword_kinds)
...
alignas_kw = TokenKind("_Alignas", keyword_kinds)
